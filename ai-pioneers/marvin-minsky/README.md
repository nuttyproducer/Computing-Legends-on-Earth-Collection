...
### SNARC — Stochastic Neural Analog Reinforcement Calculator (1951)
...
- **Minsky, M. & Papert, S.** (1972). "Artificial Intelligence Progress Report." MIT AI Lab Memo 252.
...
|------|-------|------------|
| 1969 | **Turing Award** | Association for Computing Machinery (ACM) |
| 1989 | Japan Prize | The Japan Prize Foundation |
| 1990 | MIT Killian Award | Massachusetts Institute of Technology |
| 2001 | Benjamin Franklin Medal | Franklin Institute |
| 2011 | BBVA Foundation Frontiers of Knowledge Award | BBVA Foundation |
...
- **[John McCarthy](../john-mccarthy/)** — Co-founded the MIT AI Lab with Minsky in 1959. Together they established one of the most important research centers in computing history.
...
- [MIT Media Lab — Marvin Minsky Page](https://web.media.mit.edu/~minsky/)
- [ACM Turing Award — Marvin Minsky](https://amturing.acm.org/award_winners/minsky_7440781.cfm)
- [Wikipedia — Marvin Minsky](https://en.wikipedia.org/wiki/Marvin_Minsky)
- [MIT AI Lab History](https://www.csail.mit.edu/about/history)
- [*The Society of Mind* — Full Text (archived)](https://aurellem.org/society-of-mind/)
...
| 1944–1945 | Served in the U.S. Navy (WWII) |
| 1950 | BA in Mathematics, Harvard University |
| 1951 | Built the SNARC neural network machine at Princeton |
| 1954 | PhD in Mathematics, Princeton University |
| 1957 | Invented the confocal scanning microscope |
| 1958 | Joined MIT faculty |
| 1959 | Co-founded the MIT AI Laboratory with John McCarthy |
| 1960s | Developed robotic arms and head-mounted display |
| 1967 | Published *Computation: Finite and Infinite Machines* |
| 1968 | Consulted on Kubrick's *2001: A Space Odyssey* |
| 1969 | Published *Perceptrons* with Seymour Papert |
| 1969 | Awarded the Turing Award |
| 1986 | Published *The Society of Mind* |
| 2006 | Published *The Emotion Machine* |
| 2016 | Died in Boston, Massachusetts |
...
4. "Marvin Minsky." *ACM A.M. Turing Award*. [https://amturing.acm.org/award_winners/minsky_7440781.cfm](https://amturing.acm.org/award_winners/minsky_7440781.cfm)
