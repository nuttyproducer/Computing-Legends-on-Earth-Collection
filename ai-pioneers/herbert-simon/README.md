...
- **Administrative Behavior** (1947) — Doctoral dissertation turned organizational theory classic
- **"A Behavioral Model of Rational Choice"** (1955) — Introduced bounded rationality and satisficing
- **"The Logic Theory Machine"** (1956, with Newell & Shaw) — First AI program paper
- **Organizations** (1958, with James March) — Influential work on organizational decision-making
- **"GPS: A Program that Simulates Human Thought"** (1961, with Newell) — General Problem Solver
- **The Sciences of the Artificial** (1969) — Design science manifesto
- **Human Problem Solving** (1972, with Newell) — Comprehensive theory of human cognition as information processing
- **Models of Discovery** (1977) — Philosophy of scientific discovery
- **Models of Thought** (Vols. 1 & 2, 1979, 1989) — Collected papers on cognitive science
- **Models of Bounded Rationality** (Vols. 1–3, 1982, 1997) — Collected papers on economics and decision-making
- **Models of My Life** (1991) — Autobiography (yes, even his memoir is titled like a scientific monograph)
...
|------|-------|--------------|
| 1969 | Distinguished Scientific Contribution Award (APA) | Recognition from the American Psychological Association |
| 1975 | **ACM Turing Award** | With Allen Newell, "for their basic contributions to artificial intelligence, the psychology of human cognition, and list processing" |
| 1978 | **Nobel Memorial Prize in Economics** | "For his pioneering research into the decision-making process within economic organizations" |
| 1986 | National Medal of Science | USA's highest scientific honor |
| 1988 | John von Neumann Theory Prize | For contributions to operations research and management science |
| 1993 | APA Award for Outstanding Lifetime Contributions to Psychology | Because one psychology award wasn't enough |

> One of the vanishingly rare individuals to hold **both** the Turing Award and the Nobel Prize. If there were a prize for winning prizes, he'd have won that too.
...
> — Predicting the internet's central problem decades before Twitter existed

> *"The aim of science is to make complex things simple."*
...
Herbert Simon's influence is almost comically broad. He is one of the very few people in history who legitimately deserves to be called a **polymath** — and that's not hyperbole, it's a statement of fact supported by Nobel committees, Turing Award committees, and psychology associations alike.

**In Artificial Intelligence:** Simon (with Newell) essentially co-founded the field. The Logic Theorist and GPS established the **symbolic AI** paradigm — the idea that intelligence is fundamentally about symbol manipulation and search. This was the dominant approach in AI for three decades, and its core insights remain relevant even in the age of deep learning.

**In Economics:** Bounded rationality didn't just tweak classical economics — it challenged its foundations. The entire field of **behavioral economics** (think Daniel Kahneman, Richard Thaler, and "Nudge") descends from Simon's insight that humans aren't perfectly rational calculators. Every time someone explains why people make "irrational" financial decisions, they're standing on Simon's shoulders.

**In Cognitive Psychology:** Simon helped establish the **information processing** model of human cognition — the idea that the mind can be understood as a system that processes symbols, much like a computer. This became the dominant paradigm in cognitive science for decades.

**In Organizational Theory:** *Administrative Behavior* remains a foundational text. Simon's ideas about how organizations actually make decisions (as opposed to how economists assumed they did) shaped management science, public administration, and business strategy.

**The Big Picture:** Simon's deepest insight may be that the same principles — search, heuristics, bounded rationality, hierarchical organization — apply across domains, from human minds to computer programs to economic organizations. He didn't just work across disciplines; he showed that the disciplines were connected.

---

## Related Figures

- **[Allen Newell](../allen-newell/)** — Lifelong collaborator and co-creator of the Logic Theorist, GPS, and much of early AI. Their partnership was one of the most productive in the history of computer science.
...
### Books by Simon
- *Administrative Behavior* (4th ed., 1997, Free Press)
- *The Sciences of the Artificial* (3rd ed., 1996, MIT Press)
- *Models of My Life* (1991, Basic Books) — His engaging autobiography

### About Simon
- Hunter Crowther-Heyck, *Herbert A. Simon: The Bounds of Reason in Modern America* (2005, Johns Hopkins University Press)
- Pamela McCorduck, *Machines Who Think* (2004) — Excellent history of AI featuring Simon prominently

### Online
- [Nobel Prize Biography](https://www.nobelprize.org/prizes/economic-sciences/1978/simon/biographical/)
- [ACM Turing Award Citation](https://amturing.acm.org/award_winners/simon_1031467.cfm)
- [Carnegie Mellon Memorial Page](https://www.cmu.edu/simon/)
- [Stanford Encyclopedia of Philosophy: Herbert Simon](https://plato.stanford.edu/entries/simon/)
...
| 1936 | BA in Political Science, University of Chicago |
| 1942 | Joins Illinois Institute of Technology faculty |
| 1943 | PhD in Political Science, University of Chicago |
| 1947 | Publishes *Administrative Behavior* |
| 1949 | Joins Carnegie Mellon University (Carnegie Institute of Technology) |
| 1955 | Introduces bounded rationality and satisficing |
| 1956 | Creates **Logic Theorist** with Allen Newell and Cliff Shaw — the first AI program |
| 1956 | Presents Logic Theorist at the Dartmouth Conference |
| 1959 | Develops **General Problem Solver** with Newell |
| 1969 | Publishes *The Sciences of the Artificial* |
| 1972 | Publishes *Human Problem Solving* with Newell |
| 1975 | **ACM Turing Award** (with Allen Newell) |
| 1978 | **Nobel Memorial Prize in Economics** |
| 1986 | National Medal of Science |
| 1991 | Publishes autobiography *Models of My Life* |
| 2001 | Dies in Pittsburgh, Pennsylvania, at age 84 |
...
2. Newell, A., & Simon, H. A. (1956). "The Logic Theory Machine." *IRE Transactions on Information Theory*, 2(3), 61–79.
3. Simon, H. A. (1955). "A Behavioral Model of Rational Choice." *Quarterly Journal of Economics*, 69(1), 99–118.
4. Newell, A., Shaw, J. C., & Simon, H. A. (1959). "Report on a General Problem-Solving Program." *Proceedings of the International Conference on Information Processing*, 256–264.
5. Simon, H. A. (1969). *The Sciences of the Artificial*. MIT Press.
6. Newell, A., & Simon, H. A. (1972). *Human Problem Solving*. Prentice-Hall.
7. Simon, H. A. (1991). *Models of My Life*. Basic Books.
8. Crowther-Heyck, H. (2005). *Herbert A. Simon: The Bounds of Reason in Modern America*. Johns Hopkins University Press.
