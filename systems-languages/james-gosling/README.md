...
### 1. Java Programming Language (1995)
- **Year:** 1995
...
- **[Dennis Ritchie](../dennis-ritchie/)** — C's influence on Java's syntax is unmistakable
...
- [James Gosling's blog](https://web.archive.org/web/2010*/nighthacks.com/jag)
- [Computer History Museum Fellow](https://computerhistory.org/profile/james-gosling/)
...
1. Gosling, J., Joy, B., Steele, G. (1996). *The Java Language Specification*. Addison-Wesley.
